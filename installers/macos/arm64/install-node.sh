...
# Node.js Installer for macOS ARM64
...
echo "🚀 Starting Node.js installation for macOS ARM64..."
...
echo "   → Frevana version: $($FREVANA_HOME/bin/node --version 2>/dev/null || echo 'None')"
...
echo "3. 📥 Downloading Node.js v$target_version for macOS ARM64..."
echo "   → URL: https://nodejs.org/dist/v$target_version/node-v$target_version-darwin-arm64.tar.gz"
...
echo "   → ln -sf $FREVANA_HOME/node/v$target_version/bin/node $FREVANA_HOME/bin/node"
echo "   → ln -sf $FREVANA_HOME/node/v$target_version/bin/npm $FREVANA_HOME/bin/npm"
...
echo "   → Node.js available at: $FREVANA_HOME/bin/node"
echo "   → npm available at: $FREVANA_HOME/bin/npm"
